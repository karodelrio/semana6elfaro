...
<body>
    ...
    <div>
        <h1 class="d-xl-flex justify-content-xl-center">¡Contáctanos!</h1>
        <h2 class="d-xl-flex justify-content-xl-center">Te responderemos en breve</h2>
    </div>
    <div class="container">
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="912345678">
        </div>
        <div class="mb-3">
            <label for="formGroupExampleInput3" class="form-label">Solicitud</label>
            <input type="text" class="form-control" id="formGroupExampleInput3" placeholder="Escribe tu solicitud">
        </div>
        <div class="col-12">
